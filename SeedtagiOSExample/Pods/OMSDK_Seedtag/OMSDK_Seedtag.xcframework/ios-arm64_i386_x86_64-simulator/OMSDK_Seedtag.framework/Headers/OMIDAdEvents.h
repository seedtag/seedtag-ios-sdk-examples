 ...
 */
@interface OMIDSeedtagAdEvents : NSObject
 ...
 */
- (nullable instancetype)initWithAdSession:(nonnull OMIDSeedtagAdSession *)session error:(NSError * _Nullable * _Nullable)error;
 ...
 */
- (BOOL)loadedWithVastProperties:(OMIDSeedtagVASTProperties *_Nonnull)vastProperties
