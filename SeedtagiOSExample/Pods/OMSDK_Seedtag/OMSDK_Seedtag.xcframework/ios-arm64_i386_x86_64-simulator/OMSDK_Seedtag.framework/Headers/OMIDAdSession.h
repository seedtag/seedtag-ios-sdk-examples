 ...
 */
@interface OMIDSeedtagAdSession : NSObject

/**
 *  The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly) OMIDSeedtagAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(OMIDSeedtagAdSessionConfiguration *)configuration
                              adSessionContext:(OMIDSeedtagAdSessionContext *)context
