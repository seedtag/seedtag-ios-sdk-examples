 ...
 */
@interface OMIDSeedtagAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(OMIDSeedtagPartner *)partner
...
- (nullable instancetype)initWithPartner:(OMIDSeedtagPartner *)partner
                               ...
                               resources:(NSArray<OMIDSeedtagVerificationScriptResource *> *)resources
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
